    ...
    <div class="mijn-keuzedelen-container">
                        ...
                        <div class="mijn-keuzedeel-card__content">
                            ...
                            <div class="mijn-keuzedeel-card__details">
                                <div class="mijn-keuzedeel-card__detail">
                                    <span class="mijn-keuzedeel-card__label">Docent:</span>
                                    <span>{{ $inschrijving->keuzedeel->docent }}</span>
                                </div>
                                <div class="mijn-keuzedeel-card__detail">
                                    <span class="mijn-keuzedeel-card__label">Locatie:</span>
                                    <span>{{ $inschrijving->keuzedeel->locatie }}</span>
                                </div>
                                <div class="mijn-keuzedeel-card__detail">
                                    <span class="mijn-keuzedeel-card__label">Inschrijfdatum:</span>
                                    <span>{{ $inschrijving->inschrijfdatum->format('d-m-Y') }}</span>
                                </div>
                                <div class="mijn-keuzedeel-card__detail">
                                    <span class="mijn-keuzedeel-card__label">EC:</span>
                            ...
                            <div class="mijn-keuzedeel-card__opmerkingen">
                                <strong>Opmerkingen:</strong> {{ $inschrijving->opmerkingen }}
                            </div>
                            @endif
                        </div>
        ...
        @else
            <div class="mijn-keuzedelen-empty">
                ...
                <h2>Geen inschrijvingen gevonden</h2>
                <p>Je hebt je nog niet ingeschreven voor keuzedelen. Bekijk de beschikbare keuzedelen en schrijf je in!</p>
                <a href="{{ route('keuzedelen') }}" class="btn btn--primary">
                    Bekijk keuzedelen
                </a>
            </div>
        @endif
