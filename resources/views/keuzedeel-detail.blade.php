...
@section('styles')
<link rel="stylesheet" href="{{ asset('css/keuzedeel-detail.css') }}">
@endsection
            ...
            <div class="keuzedeel-detail__content">
                ...
                <div class="keuzedeel-detail__sidebar">
                    <div class="keuzedeel-detail__card">
                        ...
                        @else
                            @php
                                    $conflicterendKeuzedeel = auth()->user()->getConflicterendKeuzedeel($keuzedeel->startdatum, $keuzedeel->einddatum);
                                @endphp
                                @if(auth()->user()->heeftKeuzedeelVoltooid($keuzedeel->id))
                                <div class="keuzedeel-detail__status-message keuzedeel-detail__status-message--success">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                    <span>Je hebt dit keuzedeel al voltooid</span>
                                </div>
                            @elseif($conflicterendKeuzedeel)
                                <div class="keuzedeel-detail__status-message keuzedeel-detail__status-message--warning">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                                    </svg>
                                    <span>Je bent al ingeschreven voor "{{ $conflicterendKeuzedeel->titel }}" in dezelfde periode</span>
                                </div>
