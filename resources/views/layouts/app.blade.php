        ...
        <div class="container">
            <div class="footer__top">
                ...
                <div class="footer__section">
                    ...
                    <div class="footer__links">
                        <a href="/login">Mijn Inschrijvingen</a>
            ...
            <div class="footer__bottom">
                <div class="footer__legal">
                    <a href="/privacy">
                        <svg class="footer__legal-icon" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zM3.293 9.293a1 1 0 011.414 0L10 14.586l5.293-5.293a1 1 0 011.414 1.414l-6 6a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414z" clip-rule="evenodd" />
                        </svg>
                        <span>Privacy</span>
                    </a>
                    <a href="/voorwaarden">
                    ...
                    <a href="/cookiebeleid">
                        <svg class="footer__legal-icon" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M10 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16zM8 7a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm8 6a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm-6-3a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
                        </svg>
                        <span>Cookies</span>
                    </a>
                ...
                <p class="footer__copy">© {{ date('Y') }} Techniek College Rotterdam. Alle rechten voorbehouden.</p>
            </div>
        </div>
    </footer>
